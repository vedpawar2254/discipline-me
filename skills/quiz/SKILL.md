---
name: quiz
description: On-demand comprehension quiz on any file, directory, or the current diff. Use when the user says /quiz, "quiz me", "test my understanding", or wants to check they understand code without waiting for the automatic gate.
---
...
- `/quiz` with no argument → quiz on the current diff (omit the path).
